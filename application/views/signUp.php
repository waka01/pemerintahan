...
<head>
    ...
    <!--fonts -->
    <!-- //fonts -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/login/css/font-awesome.css" type="text/css" media="all">
        ...
        <button type="button" data-target="#navigation" class="navbar-toggler btn-template-outlined" data-toggle="collapse"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="nav navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown active "><a href="<?php echo site_url('login')?>" data-toggle="faq">Account</a>
              </li>
            </ul>
          </div>
        </div>
...
<!-- Navbar End-->
            ...
            <form action="#" method="post">
                <div class="field-group">
                    ...
                    <div class="wthree-field">
                        <input name="text1" id="text1" type="text" value="" placeholder="Nama Lengkap" required>
                    </div>
                </div>
                <div class="field-group">
                    <span class="fa fa-users" aria-hidden="true"></span>
                    <div class="wthree-field">
                        <input name="password" id="myInput" type="Password" placeholder="Username">
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    ...
                    <div class="wthree-field">
                        <input name="password" id="myInput" type="Password" placeholder="Konfirmasi Password">
                    </div>
                </div>
                <div class="wthree-field">
    ...
    <!-- FOOTER -->
    <footer class="main-footer" style="background-color: rgba(255, 255, 255, 0.1)">
           <div class="container">
             <div class="row">
               <div class="col-lg-4">
