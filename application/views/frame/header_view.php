...
<head>
    ...
    <link href="<?php echo base_url();?>assets/js/jquery-ui-1.11.4.custom/jquery-ui.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url();?>assets/js/jquery-ui-1.11.4.custom/jquery-ui-custom-datepicker.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <img id="loading"  width="80px" src="<?=base_url()?>assets/images/loading.gif" alt="Loading...">
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">
                    <div class="inline"> &nbsp;Administrator </div>
                </a>
